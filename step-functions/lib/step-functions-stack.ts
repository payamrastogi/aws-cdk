...
import { OutOfInfrequentAccessPolicy } from 'aws-cdk-lib/aws-efs';
...
export class StepFunctionsStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const generateRandomNumber = new lambda.Function(this,
    ...
    //Lambda function called if the generted number is greater than the expected number
    const functionGreaterThan = new lambda.Function(this,
    "NumberGreaterThan", {
      runtime: lambda.Runtime.NODEJS_18_X,
      code: lambda.Code.fromAsset('lambda'),
